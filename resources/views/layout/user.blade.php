...
<body>
    ...
    <nav class="navbar sticky-top bg-dark">
      <div class="container-fluid">
        <a class="navbar-brand text-white">Todo Website</a>
          <button class="btn btn-outline-danger" type="submit"><a href="/logout" style="color:rgb(255, 255, 255); text-decoration:none;">Logout</a></button>
      </div>
    </nav>
      @endif 
