                  ...
                  <div class="row ">
                    ...
                    <div class="col-lg-6">
                        <div class="card-body p-md-5 mx-md-4">
                            ...
                            @endif
                            <p class="title-form">Please login to your account!</p>
          
                            <div class="form-outline mb-4">
                                <label class="form-label lbel" for="form2Example11">Username</label>
                            ...
                            <div class="d-flex align-items-center justify-content-center pb-4">
                              ...
                              <button type="button" class="btn btn-outline-danger"><a class="toregister" href="/register">Create new<a></button>
                            </div>
